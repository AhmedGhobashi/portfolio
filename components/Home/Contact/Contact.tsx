...
const Contact = () => {
  return (
    <div className='bg-gray-100 dark:bg-gray-950 py-16'>
      <SectionHeader title_1='Get In' title_2='Touch' description="Have a project in mind or just want to say hi? I'd love to hear from you." />
                ...
                <form className='bg-white dark:bg-gray-800 rounded-2xl p-8 space-y-6'>
                    <div className='grid sm:grid-cols-2 gap-4'>
                        <div className='space-y-4'>
                            ...
                            <Input type="text" id='name' placeholder='your name' name='name'  required className='bg-gray-100' />
                        </div>
                        ...
                        <div className='space-y-4'>
                            ...
                            <Input type='email' id='email' placeholder='your email' name='email'  required className='bg-gray-100' />
                        </div>
                    </div>
                    ...
                    <div className='space-y-2'>
                        ...
                        <Input type='text' id='subject' placeholder='project inquiry' name='subject'  required className='bg-gray-100' />
                    </div>
                    ...
                    <div className='space-y-2'>
                        ...
                        <Textarea id='message' name='message' placeholder='tell me about your project/idea' rows={5} required className='bg-gray-100 h-40' />
                    </div>
