...
const MobileNav = ({showNav, closeNav}: Props) => {
  ...
  return (
    <div>
      ...
      {/* nav links */}
      <div className={`text-white fixed ${sidebarOpenClose} justify-center flex-col h-full transform transtion-all duration-500 delay-300 w-[80%] sm:-w[60%] bg-purple-700 space-y-6 z-1050`}>
